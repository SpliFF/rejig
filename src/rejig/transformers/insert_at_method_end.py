"""Transformer to insert statements at method/function end."""
from __future__ import annotations

import libcst as cst


class InsertAtMethodEnd(cst.CSTTransformer):
    """Insert a statement at the end of a method body.
    ...
    Examples
    --------
    >>> transformer = InsertAtMethodEnd("MyClass", "my_method", "return result")
